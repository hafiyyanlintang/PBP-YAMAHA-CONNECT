...
class MaxiPage extends StatefulWidget {
  final String email;
  final bool darkMode;
  ...
  @override
  State<MaxiPage> createState() => _MaxiPageState();
}

class _MaxiPageState extends State<MaxiPage> {
  Timer? _timer;
...
class _MaxiListItem extends StatelessWidget {
  final Maxi maxi;
  final VoidCallback onTap;

  const _MaxiListItem({required this.maxi, required this.onTap});
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Hero(
                  tag: maxi.name,
                  child: Image.asset(maxi.image, width: 100),
                ),
