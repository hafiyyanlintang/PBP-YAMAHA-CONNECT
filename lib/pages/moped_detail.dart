...
class MopedDetailPage extends StatefulWidget {
  final Moped moped;
  final String email;
  final bool darkMode;

  const MopedDetailPage({
    super.key,
    required this.moped,
    required this.email,
  ...
  @override
  State<MopedDetailPage> createState() => _MopedDetailPageState();
}

class _MopedDetailPageState extends State<MopedDetailPage> {
  int _selectedColorIndex = 0;
  final List<Color> _availableColors = [
    const Color(0xFFd32f2f), // Merah
    const Color(0xFF1976D2), // Biru
    const Color(0xFF303030), // Hitam
  ];
            ...
            slivers: [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  centerTitle: true,
                  background: Hero(
                    tag: widget.moped.name,
                    child: Image.asset(widget.moped.image, fit: BoxFit.contain),
                  ),
                ),
              ),
              SliverList(
  ...
  Widget _buildKeySpecs(Color textColor) {
    return GridView.count(
      ...
      children: widget.moped.specs.entries.map((entry) {
        return Container(
