...
class ClassyDetailPage extends StatefulWidget {
  final Classy classy;
  final String email;
  final bool darkMode;

  const ClassyDetailPage({
    super.key,
  ...
  @override
  State<ClassyDetailPage> createState() => _ClassyDetailPageState();
}

class _ClassyDetailPageState extends State<ClassyDetailPage> {
  int _selectedColorIndex = 0;
  final List<Color> _availableColors = [
    const Color(0xFFcad2c5), // Sage Green
    const Color(0xFFf2e9e4), // Beige
    const Color(0xFF212121), // Hitam
    const Color(0xFFfafafa), // Putih
  ];
  ...
  Widget _buildHeader(Color textColor) {
    return Row(
      ...
      children: [
        Chip(
          label: const Text("Classy Series"),
          backgroundColor: const Color(0xFF84a98c).withOpacity(0.2),
  ...
  Widget _buildKeySpecs(Color textColor) {
    return GridView.count(
      ...
      children: widget.classy.specs.entries.map((entry) {
        return Container(
