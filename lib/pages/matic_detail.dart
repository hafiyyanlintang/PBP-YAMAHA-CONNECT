...
class MaticDetailPage extends StatefulWidget {
  final Matic matic;
  final String email;
  final bool darkMode;

  const MaticDetailPage({
    super.key,
    required this.matic,
    required this.email,
  ...
  @override
  State<MaticDetailPage> createState() => _MaticDetailPageState();
}

class _MaticDetailPageState extends State<MaticDetailPage> {
  int _selectedColorIndex = 0;
  final List<Color> _availableColors = [
    const Color(0xFFc62828), // Merah
    const Color(0xFF283593), // Biru
    const Color(0xFF424242), // Hitam
    const Color(0xFFEEEEEE), // Putih
  ];
            ...
            slivers: [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  centerTitle: true,
                  background: Hero(
                    tag: widget.matic.name,
                    child: Image.asset(widget.matic.image, fit: BoxFit.contain),
                  ),
                ),
              ),
              SliverList(
  ...
  Widget _buildKeySpecs(Color textColor) {
    return GridView.count(
      ...
      children: widget.matic.specs.entries.map((entry) {
        return Container(
